...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_messageservice_messageservice__ = __webpack_require__(198);
...
var HomePage = (function () {
    ...
    HomePage.prototype.getMessages = function () {
        var _this = this;
        this.messageService.getMessages().subscribe(function (data) { return _this.messages = data; }); // Subscibe Method
        // this.messages = this.messageService.getMessages();    // pipe async method ---> add |async in html
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\Elyes\Desktop\ionic\http\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n     Json manipulation\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  \n<ion-list *ngFor="let message of messages">\n    <ion-item>\n            {{message.id}}   \n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\Elyes\Desktop\ionic\http\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__providers_messageservice_messageservice__["a" /* MessageserviceProvider */]])
    ], HomePage);
    return HomePage;
}());
...
var MessageserviceProvider = (function () {
    function MessageserviceProvider(http) {
        this.http = http;
        this.url = 'assets/data/testing.json';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_messageservice_messageservice__ = __webpack_require__(198);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__providers_messageservice_messageservice__["a" /* MessageserviceProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Elyes\Desktop\ionic\http\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Users\Elyes\Desktop\ionic\http\src\app\app.html"*/
        }),
